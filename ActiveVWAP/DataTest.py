...
IntervalBorderList = []
TradeDayPriceList = []
HistoryFiveMinOpenPriceDifferList = []
CurrentOpenPricesDifferList = []
ForcastAveragePricesDifferList = []
...
if __name__ == '__main__':
    ...
    print("CurrentOpenPricesDifferList", CurrentOpenPricesDifferList)
    print("ForcastAveragePricesDifferList", ForcastAveragePricesDifferList)

    '''ifsList = GetIFS(0, HistoryFiveMinOpenPriceList, CurrentAveragePricesList, ForcastAveragePricesList, 0.6)
